...
static const int MAX_STAT_ITEM_NAME_LENGTH = 32; //!<统计项的名字最大长度
static const int MAX_STAT_ITEM_NUM = 16; //!<每个统计段最多有多少个统计项
static const int MAX_STAT_SECTION_NAME_LENGTH = 64; //!<统计段的名字最大长度
static const int MAX_STAT_SECTION_STRING_LENGTH = 1024; //!<每一个统计段打印到文件中每一行的最长长度
